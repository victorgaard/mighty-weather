    ...
    return (
        <>
            {permissionCoord ? loadingCoord ?
                ...
                <>
                    <button
                        className="Nav__button--denied"
                        onClick={getCoordinates}>
                        <img
                            src={mapIconDisabled}
                            alt="Map icon disabled" />
                    </button>
                    <div className="Nav__coords--denied">
                        <p>Access to location was denied. Please allow location from your browser settings.</p>
                    </div>
                </>
            }
        </>
